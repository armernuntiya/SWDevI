...
exports.addAppointment=async (req,res,next)=>{
    try{
        ...
        if(!hospital){
            return res.status(400).json({success:false,message:`No hospital with the id of ${req.params.hospitalId}`});
        }
        ...
        //If the user is not an admin, they can only create appointment.
